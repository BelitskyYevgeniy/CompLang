...
namespace CompLang
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private WordInputDialog MakeWordInputDialog(string title, string description)
        {
            var wordInputDialog = new WordInputDialog(title, description, _wordProvider);
        ...
        public MainWindow(IWordProvider wordProvider, IWordService wordService, ITextService textService, IPaginationManager paginationManager, IConfiguration configuration)
        {
        ...
        private async void OnLoad(object sender, EventArgs e)
        {
            ...
            MessageBox.Show((await _wordProvider.GetAsync(134 * 20, 20, false, SortType.Count, SortDirection.Ascending, null, App.Ct)).Count().ToString());
        }
        ...
        private async void ParseText_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
                foreach (var filename in fileDialog.FileNames)
                {
                    ...
                    await _textService.AddAsync(new Text { Title = fileDialog.FileName, Content = text }, App.Ct);
                }
                await FillDataGrid();
            }
        }
